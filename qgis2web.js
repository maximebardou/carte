...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-135523.781255, 5740990.161601, -83083.130386, 5789531.887532], maxZoom: 22, minZoom: 10
    })
});
...
map.getView().fit([-135523.781255, 5740990.161601, -83083.130386, 5789531.887532], map.getSize());
